...
<body>
	<div class="main">
		...
		<form id="form1" method="post" action="user?cmd=uploadPic"
				...
				<table class="box">
					...
					<tr>
						...
						<td><input type="password" name="userPassword2" class="text"
							id="userPassword2" /> <font color="red">*</font></td>
					</tr>
					...
					<tr>
						...
						<td><input type="radio" name="type" id="type" value="1"
							checked="checked" />普通用户 <input type="radio" name="type"
							id="type" value="0" />经理 <font color="red">*</font></td>
					</tr>
					<tr>
						<td class="field">用户头像：</td>
						<td><input type="file" name="pic" id="pic"> <font
							color="red">*允许图片的格式为:png,jpg,JPEG,gif;大小不超过5M</font></td>
					</tr>
				</table>
			</div>
			<div class="buttons">
				<input type="button" name="button" id="button" value="数据提交"
					class="input-button" onclick="checkForm();" /> <input
					type="button" name="button" id="button"
					onclick="window.location='user.do';" value="返回"
					class="input-button" />
			</div>
		</form>
	</div>
