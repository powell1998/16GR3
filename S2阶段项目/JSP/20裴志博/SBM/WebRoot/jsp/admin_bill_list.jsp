			...
			<table class="list">
				...
				<c:forEach items="${pageBean.data }" var="accountDetail">
					<tr>
						...
						<td><a href="provider?cmd=getAllProvider&&action=update&&accountId=${accountDetail.goodsId }">修改</a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
		<form id="from" action="account?cmd=getPageBean">
