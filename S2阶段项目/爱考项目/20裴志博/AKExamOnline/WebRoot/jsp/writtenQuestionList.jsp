...
<body>
	<div>
		...
		<br> <input type="button" value="添加试题"
			onclick="showAddQuestion();" style="float:left;margin-right: 20px;">
		<form
			action="question/question_inportWrittenQuestions?course.csId=${course.csId }&course.csName=${course.csName}"
			method="post" enctype="multipart/form-data"
			style="float: left;margin-right: 20px;">
			<input type="file" name="questionfile"> <input type="submit"
				value="导入">
		</form>
		<a href="file/Template_01.xls"><input type="button" value="下载试题模板"></a>
		...
		<table width="100%" align="center" id="marginTop" border="1"
			...
			<s:iterator value="pageBean.Items" var="writtenQuestion"
				...
				<tr>
					...
					<td><a
						href='javascript:showUpdateQuestion(${writtenQuestion.qid })'>编辑</a>
